...
class Defines
	...
	def initialize(filename)
		...
		@column_Format={"2monthSorted_trace"=>1,"10k_trace"=>1 ,
			...
			"soun1k_trace"=>2,"souneilSorted_trace"=>2} 	#awazza dataset 1million reqs
