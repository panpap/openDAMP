class Defines
	attr_accessor :traceFile, :columnsFormat, :rootDir, :dataDir, :adsDir, :userDir, :resources, :parseResults, :formatFile, :impFile, :adfile, :prices, :priceTagsFile, :devices, :bcnFile, :size3rdFile, :paramsNum, :adDevices, :beaconT, :userFile, :filterFile, :publishers, :leftovers, :beacon_key, :imps, :keywords, :adInParam
