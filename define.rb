...
'TotalBytes_Other_data INTEGER, TotalBytes_Other_gif INTEGER, TotalBytes_Other_html INTEGER, TotalBytes_Other_image INTEGER, TotalBytes_Other_other INTEGER, TotalBytes_Other_script INTEGER, TotalBytes_Other_styling INTEGER, TotalBytes_Other_text INTEGER, TotalBytes_Other_video INTEGER'},
			...
			"csyncTable"=>{"csyncResults"=>'user VARCHAR, prevTimestamp BIGINT,curTimestamp BIGINT,hostPrev VARCHAR,prevCat VARCHAR, hostCur VARCHAR,curCat VARCHAR, paramNamePrev VARCHAR, syncedID VARCHAR, paramNameCur VARCHAR, prevStatus INTEGER, curStatus INTEGER, possibleNumberOfIDs INTEGER,confirmed INTEGER, allParamsPrev VARCHAR, allParamsCur VARCHAR,urlPrev VARCHAR,urlCur VARCHAR, prevHttpRef VARCHAR, curHttpRef VARCHAR, dev VARCHAR, prevBrowser VARCHAR, curBrowser VARCHAR, prevUA VARCHAR, curUA VARCHAR,id VARCHAR PRIMARY KEY'},
			"visitsTable"=>{"userVisits"=> 'userID VARCHAR PRIMARY KEY, totalVisits INTEGER,visits VARCHAR, interests VARCHAR'},
			"webTraceTable"=>{"webTraceResults"=>'totalRows BIGINT, users INTEGER, advertising INTEGER, analytics INTEGER, social INTEGER, third_party_content INTEGER, beacons INTEGER, other INTEGER, thirdPartySize_total INTEGER, totalMobileReqs INTEGER, browserReqs INTEGER, hashedPrices INTEGER, numericPrices INTEGER, id VARCHAR PRIMARY KEY'},
			"appTraceTable"=>{"appTraceResults"=>'totalRows BIGINT, users INTEGER, advertising INTEGER, analytics INTEGER, social INTEGER, third_party_content INTEGER, beacons INTEGER, other INTEGER, thirdPartySize_total INTEGER, totalMobileReqs INTEGER, browserReqs INTEGER, hashedPrices INTEGER, numericPrices INTEGER, id VARCHAR PRIMARY KEY'},
		}
