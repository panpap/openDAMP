...
class Defines
	...
	def initialize(filename)
		...
		@siteFile="./sites.csv"
		@resources="resources/"
		@resourceFiles={"filterFile"=>@resources+"disconnect_merged.json",
