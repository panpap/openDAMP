...
class Operations
	...
	prices=trace.detectedPrices
		...
		puts "Total Number of rows = "+(trace.party3rd['Advertising']+trace.party3rd['Analytics']+trace.party3rd['Social']+trace.party3rd['totalBeacons']+trace.party3rd['Content']+trace.party3rd['Other']).to_s
